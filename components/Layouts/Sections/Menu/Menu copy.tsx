...
const MenuLinks = [
  ...
  },
  {
    ...
    dataIcon: "linkedin",
    label: "LinkedIn",
    tag: "https://linkedin.com/in/dnachavez",
    target: "_blank"
  },
  {
    icon: <GitHubSvgIcon />,
    dataIcon: "github",
    label: "GitHub",
    tag: "https://github.com/dnachavez",
    target: "_blank"
  },
  {
    ...
    dataIcon: "instagram",
    label: "Instagram",
    tag: "https://www.instagram.com/dnachave",
    target: "_blank"
  },
  {
    icon: <TikTokSvgIcon />,
    dataIcon: "tiktok",
    label: "TikTok",
    tag: "https://www.tiktok.com/@dnachave",
    target: "_blank"
  },
]
...
const Menu = () => {
  ...
  // const $menu: any = document.getElementById("topbar-menu");
  // const $menuBtn: any = document.getElementById("topbar-menu-button");
  // const $menuItems = document.querySelectorAll(".menu-item");
  // const $topbarMenuContainer = document.getElementById("topbar-menu-container");

  // $menuBtn.addEventListener("click", (event: any) => {
  ...
  //     isButtonActive === "true" ? "auto" : "hidden";
  //   if (isButtonActive) $menu.setAttribute("data-icon", "");
  // });
  ...
  //     $menu.setAttribute("data-icon", icon);
  //   });
  // });

  return (
    <div className="" id="topbar-menu-container">
      <button
      ...
      >
        ...
        <svg
          className="hidden group-data-[active=true]:flex"
          width="28"
          height="28"
          strokeWidth="1.5"
          viewBox="0 0 24 24"
      ...
      >
        ...
        <li>
          <a
            data-icon="instagram"
            className="menu-item flex items-center py-4 pl-20 md:pl-[calc((100vw-900px)/2)] text-[2rem] font-extrabold gap-8 text-light-gray-primary hover:text-light-texto-primary dark:text-dark-gray-primary hover:dark:text-dark-texto-primary md:hover:pl-[calc((100vw-900px)/2+2rem)] transition-all"
            href="https://www.instagram.com/dnachavez"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a
            data-icon="tiktok"
            className="menu-item flex items-center py-4 pl-20 md:pl-[calc((100vw-900px)/2)] text-[2rem] font-extrabold gap-8 text-light-gray-primary hover:text-light-texto-primary dark:text-dark-gray-primary hover:dark:text-dark-texto-primary md:hover:pl-[calc((100vw-900px)/2+2rem)] transition-all"
            href="https://www.tiktok.com/@dnachavez"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {/* <!-- <li>
            <a
                data-icon="dribbble"
                className="menu-item flex items-center py-4 pl-20 md:pl-[calc((100vw-900px)/2)] text-[2rem] font-extrabold gap-8 text-light-gray-primary hover:text-light-texto-primary dark:text-dark-gray-primary hover:dark:text-dark-texto-primary md:hover:pl-[calc((100vw-900px)/2+2rem)] transition-all"
                href="https://dribbble.com/devenapuros"
                target="_blank"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    ></path><path d="M21.75 12.84c-6.62-1.41-12.14 1-16.38 6.32"
                    ></path><path d="M8.56 2.75c4.37 6 6 9.42 8 17.72"
                    ></path></svg
                >
                Dribbble
            </a>
        ...
        <li>
            <a
                data-icon="codepen"
                className="menu-item flex items-center py-4 pl-20 md:pl-[calc((100vw-900px)/2)] text-[2rem] font-extrabold gap-8 text-light-gray-primary hover:text-light-texto-primary dark:text-dark-gray-primary hover:dark:text-dark-texto-primary md:hover:pl-[calc((100vw-900px)/2+2rem)] transition-all"
                href="https://codepen.io/devenapuros"
                target="_blank"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    ></polygon><line x1="12" x2="12" y1="22" y2="15.5"
                    ></line><polyline points="22 8.5 12 15.5 2 8.5"
                    ></polyline><polyline points="2 15.5 12 8.5 22 15.5"
                    ></polyline><line x1="12" x2="12" y1="2" y2="8.5"
                    ></line></svg
                >
                CodePen
            </a>
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=skills]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 16 16"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=jobs]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=projects]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=education]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=linkedin]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=github]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=instagram]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          viewBox="0 0 24 24"
        ...
        <svg
          className="text-[#bbb] dark:text-[#333] group-data-[icon=tiktok]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
          xmlns="http://www.w3.org/2000/svg"
          width="512"
          height="512"
          fillRule="evenodd"
        ...
        {/* <!-- <svg
            className="text-[#bbb] dark:text-[#333] group-data-[icon=dribbble]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
            xmlns="http://www.w3.org/2000/svg"
            width="512"
            height="512"
            viewBox="0 0 24 24"
            ...
            strokeLinejoin="round"
            ><circle cx="12" cy="12" r="10"></circle><path
                d="M19.13 5.09C15.22 9.14 10 10.44 2.25 10.94"></path><path
                d="M21.75 12.84c-6.62-1.41-12.14 1-16.38 6.32"></path><path
                d="M8.56 2.75c4.37 6 6 9.42 8 17.72"></path></svg
        >
        <svg
            className="text-[#bbb] dark:text-[#333] group-data-[icon=codepen]/icon:opacity-100 opacity-0 transition-opacity hidden md:block absolute -bottom-20 -right-20"
            xmlns="http://www.w3.org/2000/svg"
            width="512"
            height="512"
            viewBox="0 0 24 24"
            ...
            ></polygon><line x1="12" x2="12" y1="22" y2="15.5"></line><polyline
