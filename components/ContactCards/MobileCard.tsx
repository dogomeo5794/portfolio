...
import { MOBILE_DISPLAY, MOBILE_LINK } from "@/lib/static-data";

const MobileCard = () => {
  return (
    <li className="flex items-center gap-2 overflow-hidden">
      {/* <svg
        className="h-auto w-[53px] min-w-[53px] dark:text-[#ffffff]"
      ...
      <svg
        className="h-auto w-[53px] min-w-[53px] text-[#555555] dark:text-[#0077b5]"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
