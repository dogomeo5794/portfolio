      ...
      <div className="skills-container">
        {/* <article className="skills-column">
            ...
            <ul className="skills-list soft">
                ...
                <li style="background-color: #ffa200">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <li style="background-color: #c56cf0">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <li style="background-color: #5F9DF7">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <li style="background-color: #f1c40f;">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <li style="background-color: #ff7675">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
