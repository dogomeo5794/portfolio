export const projects = [
  ...
  //   projectSlogan:
  //     "Translate modern Filipino texts into ancient Philippine scripts",
  //   projectDescription:
  //     "Philippine Scripts Translator is a tool to translate modern Filipino texts into ancient Philippine scripts that are included in the unicode charts. This project is inspired by jennayey's Philippine Script Translator and uses Next.js as its development framework.",
  ...
  //   projectDescription:
  //     "Google Translation is a tool for translating between languages that Google Translate supports. This project uses Next.js for its development framework as well as the Google Translate API from Pawan.Krd.",
